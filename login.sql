...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2024 a las 01:11:31
...
CREATE TABLE `user` (
  ...
  `nombre_acu` varchar(40) NOT NULL,
...
INSERT INTO `user` (`doc`, `name`, `contrasena`, `email`, `id_tip_user`, `estado`, `nombre_acu`, `tel_cel`) VALUES
...
('1007428013', 'ANGIE GUTIERREZ', 'angie123', 'angie@gmail.com', 1, '', 'DIANA LEIVA MUÑOZ', 2147483647),
