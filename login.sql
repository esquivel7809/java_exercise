...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2024 a las 02:48:15
...
INSERT INTO `cuidad` (`id_cuidad`, `cuidad`) VALUES
(1, 'Ibague'),
(2, 'Bogota');
...
INSERT INTO `user` (`doc`, `name`, `contrasena`, `email`, `id_tip_user`, `estado`, `eps`, `cuidad`) VALUES
...
('11111333014', 'YURICA DUCUARA C', '$2y$10$lRQTOT8yDz2P78Xk3VKa7OW9OWiDlFgau8ajgkIkIxISmzo8Ldl3m', 'yuriducu04@gmail.com', 1, '', 'NUEVA EPS', '1'),
...
--
ALTER TABLE `cuidad`
  MODIFY `id_cuidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
